...
namespace TestingSuite.Tests
{
    ...
    public class SerializeMock2Test
    {
        ...
        {
            this.dataSingleCompact = Tools.CreateMockObjectsX<Mock2>(1, 'C');
            this.dataSinglePretty = Tools.CreateMockObjectsX<Mock2>(1, 'P');
            this.dataMulti1000Compact = Tools.CreateMockObjectsX<Mock2>(1000, 'C');
            this.dataMulti1000Pretty = Tools.CreateMockObjectsX<Mock2>(1000, 'P');
            this.dataMulti10000Compact = Tools.CreateMockObjectsX<Mock2>(10000, 'C');
            this.dataMulti10000Pretty = Tools.CreateMockObjectsX<Mock2>(10000, 'P');
            this.dataMulti100000Compact = Tools.CreateMockObjectsX<Mock2>(100000, 'C');
            this.dataMulti100000Pretty = Tools.CreateMockObjectsX<Mock2>(100000, 'P');
