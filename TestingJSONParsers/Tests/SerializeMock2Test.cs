...
namespace TestingSuite.Tests
{
    ...
    public class SerializeMock2Test
    {
        private readonly List<Mock2>? dataSingleCompact;
        private readonly List<Mock2>? dataSinglePretty;
        private readonly List<Mock2>? dataMulti1000Compact;
        private readonly List<Mock2>? dataMulti1000Pretty;
        private readonly List<Mock2>? dataMulti10000Compact;
        private readonly List<Mock2>? dataMulti10000Pretty;
        private readonly List<Mock2>? dataMulti100000Compact;
        private readonly List<Mock2>? dataMulti100000Pretty;

        public SerializeMock2Test()
        {
            this.dataSingleCompact = Tools.CreateMockObjectsX<Mock2>(1, 'C', false);
            this.dataSinglePretty = Tools.CreateMockObjectsX<Mock2>(1, 'P', false);
            this.dataMulti1000Compact = Tools.CreateMockObjectsX<Mock2>(1000, 'C', false);
            this.dataMulti1000Pretty = Tools.CreateMockObjectsX<Mock2>(1000, 'P', false);
            this.dataMulti10000Compact = Tools.CreateMockObjectsX<Mock2>(10000, 'C', false);
            this.dataMulti10000Pretty = Tools.CreateMockObjectsX<Mock2>(10000, 'P', false);
            this.dataMulti100000Compact = Tools.CreateMockObjectsX<Mock2>(100000, 'C', false);
            this.dataMulti100000Pretty = Tools.CreateMockObjectsX<Mock2>(100000, 'P', false);
