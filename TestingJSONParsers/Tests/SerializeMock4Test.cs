...
namespace TestingSuite.Tests
{
    ...
    public class SerializeMock4Test
    {
        ...
        {
            this.dataSingleCompact = Tools.CreateMockObjectsX<Mock4>(1, 'C', false);
            this.dataSinglePretty = Tools.CreateMockObjectsX<Mock4>(1, 'P', false);
            this.dataMulti1000Compact = Tools.CreateMockObjectsX<Mock4>(1000, 'C', false);
            this.dataMulti1000Pretty = Tools.CreateMockObjectsX<Mock4>(1000, 'P', false);
            this.dataMulti10000Compact = Tools.CreateMockObjectsX<Mock4>(10000, 'C', false);
            this.dataMulti10000Pretty = Tools.CreateMockObjectsX<Mock4>(10000, 'P', false);
            this.dataMulti100000Compact = Tools.CreateMockObjectsX<Mock4>(100000, 'C', false);
            this.dataMulti100000Pretty = Tools.CreateMockObjectsX<Mock4>(100000, 'P', false);
